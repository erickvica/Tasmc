...
public class ManejadorBD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("CREATE TABLE itinerario ("
                + "id INTEGER PRIMARY KEY AUTOINCREMENT, " + "nombre TEXT," + "actividades TEXT,"
                + "fecha TEXT)");
        ...
        db.execSQL("CREATE TABLE servicio ("
                + "id INTEGER PRIMARY KEY AUTOINCREMENT, " + "categoria TEXT," + "servicio TEXT," + "giro TEXT)");
    }
    ...
    public void guardarItinerario(Actividad actividad) {
        db = getWritableDatabase();
        db.execSQL("INSERT INTO actividad VALUES ( null,'" + actividad.getViaje() + "','" + actividad.getActividades() + "')");
    }
    ...
    public void guardarServicio(Servicio servicio) {
        db = getWritableDatabase();
        db.execSQL("INSERT INTO servicio VALUES ( null,'" + servicio.getCategoria() + "','" + servicio.getNombre() + "','"
                + servicio.getGiro() + "')");
    }
    ...
    public void borrarItinerario(Actividad actividad) {
        db = getWritableDatabase();
        //db.delete(nombreTabla,valores,clausulaWhere,argumentosWhere);
        db.delete("itinerario", "id=?", new String[]{Integer.toString(actividad.getId())});
    }
